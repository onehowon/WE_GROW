...
<img src="https://github.com/user-attachments/assets/5b8c3c47-91bc-4e63-8291-608c65ecbb09" width="100%" alt="리드 유입 페이지 1">
<img src="https://github.com/user-attachments/assets/86a93fba-be10-4a55-8321-81e036b49c17" width="100%" alt="리드 유입 페이지 2">
...
<img src="https://github.com/user-attachments/assets/27d3884b-1bff-44e4-937d-97a89bf21f1f" width="100%" alt="상담사 에스컬레이션">

- **AI 기반 계약 확인 및 오딧(Audit) 자동화** : 계약 과정에서의 오류를 방지하기 위해 AI가 문서를 검토하고 알림을 발송합니다

스크린샷이 잘리는 이유는 이미지 태그에 고정된 픽셀 너비(예: width="1893")가 너무 크게 설정되어 있어서 그렇습니다. 깃허브 화면 너비보다 이미지가 더 커서 옆부분이 잘려 보이는 현상입니다.

이를 해결하려면 고정된 숫자를 지우고, **width="100%"**를 적용해서 "화면 크기에 맞춰서 꽉 채워라"라고 설정해야 합니다. 높이(height)는 자동으로 비율에 맞게 조절되도록 지워야 합니다.

제가 사용자님이 주신 코드에서 모든 이미지 태그를 수정하여 화면에 딱 맞게(반응형으로) 고친 최종 코드를 드립니다. 이걸 그대로 복사해서 README.md 내용 전체를 덮어쓰시면 해결됩니다.

✅ 수정된 최종 README.md 코드 (복사해서 덮어쓰세요)
Markdown

<p align="center">
  <img width="300" alt="WeGrowLogo" src="https://github.com/user-attachments/assets/44073941-d111-40d6-9ce5-053733de73e0" />
</p>
<h1 align="middle">WE:GROW - Agentforce & Omni-Channel Service Hub</h1>
<h3 align="middle">Salesforce Agentforce와 Omni-Channel을 결합하여 구축한 지능형 유지보수 및 리드 관리 시스템</h3>
...
### 4. AI 기반 계약 확인 및 오딧(Audit) 자동화
계약 과정에서의 오류를 방지하기 위해 AI가 문서를 검토하고 알림을 발송합니다.

<img src="https://github.com/user-attachments/assets/7a9bb728-d082-4726-b6c3-7cfe5d9e6db6" width="100%" alt="AI 기반 계약 검수">

<br/>

## 🔨 프로젝트 구조
- 세일즈포스 DX(SFDX) 표준 구조를 따르며, 핵심 로직은 다음과 같이 분류되어 있습니다.
<img src="https://github.com/user-attachments/assets/3b719f7a-19b2-4957-9971-0395b2eb8e62" width="100%" alt="아키텍처 구조도">
